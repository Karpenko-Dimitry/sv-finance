...
return [
    'currency_exchange' => [
        'message' => [
            ...
            'city' => 'Выберите город для :action валюты:',
    ...
    'crypto_exchange' => [
        ...
        'order' => [
            ...
            'custom_city' => 'свой вариант',
            'currency_type' => 'Тип валюты по оплате:',
    ...
    'international_cache_transfer_from_rf' => [
        ...
        'order' => [
            ...
            'custom_city' => 'Город отправления перевода:',
            'currency' => 'Валюта отправления:',
            'custom_currency' => 'Валюта отправления:',
    ...
    'international_cache_transfer_to_rf' => [
        ...
        'order' => [
            ...
            'custom_currency' => 'Валюта отравления:',
    ...
    'international_sepa_transfer_from_rf' => [
        ...
        'order' => [
            ...
            'recipient_currency' => 'Валюта получения:',
            'transfer_type' => 'Метод получения средств:',
    ...
    'international_sepa_transfer_to_rf' => [
        'message' => [
            ...
            'bank_transfer' => 'Укажите банк платежной карты для выплаты SEPA перевода:',
        ...
        'order' => [
            'direction' => 'Направление перевода:',
            'sender_country' => 'Страна/город отправителя:',
    ...
    'international_swift_transfer_from_rf' => [
        'message' => [
            ...
            'transfer_type' => 'Метод передачи денежных средств:',
    ...
    'sailor_services_accept_payment' => [
        'message' => [
            ...
            'currency' => 'Укажите валюту отправки платежа:',
            'amount' => 'Укажите сумму отправки валютного платежа:',
            'transfer_type' => 'Укажите способ получения валютного платежа:',
            'city_transfer' => 'Укажите город выдачи валютного платежа:',
            'recipient_currency' => 'Укажите валюту выдачи платежа:',
        ],
        'button' => [
        ...
        'order' => [
            ...
            'transfer_type' => 'Метод получения валютного платежа:',
            'custom_transfer' => 'Метод получения валютного платежа:',
            'city_transfer' => 'Город выдачи валютного платежа:',
            'custom_city_transfer' => 'Город выдачи валютного платежа:',
            'recipient_currency' => 'Валюта выдачи платежа:',
        ]
    ],
    ...
    'payment_invoice' => [
        'form' => [
            ...
            'label' => [
                ...
                'example' => 'Пример:',
                'task' => 'Задача:',
                'task_example' => 'НАПРИМЕР: оплатить сумму в 3 млн долларов - отдаем USDT',
                'conditions' => 'Условия:',
                'conditions_example' => 'НАПРИМЕР: За оборудование согласно инвойса',
            ]
        ],
        'order' => [
    ...
    'return_foreign_currency_revenue' => [
        'form' => [
            ...
            'label' => [
                ...
                'example' => 'Пример',
                'task' => 'ЗАДАЧА:',
                'task_example' => 'НАПРИМЕР: Принять сумму в 3 млн долларов - мы хотим получить USDT',
                'conditions' => 'Условия:',
                'conditions_example' => 'НАПРИМЕР: За оборудование согласно инвойса',
            ],
            'button' => [
    ...
    'payment_agency_agreement' => [
        'message' => [
            ...
            'country' => 'Укажите страну получателя:',
            'amount' => 'Укажите сумму:',
            'currency' => 'Укажите валюту:',
            'custom_currency' => 'Укажите свою валюту:',
            'city' => 'Укажите место получения:',
            'custom_city' => 'Укажите свое место получения:',
            'file' => 'Отправьте файл или нажмите продолжить:',
    ...
    'feedback' => [
        'message' => [
            'start' => 'Нам очень важно ваше мнение, и мы будем признательны, если вы оставите отзыв о вашем опыте. Пожалуйста уделите несколько минут для написания отзыва!',
            'complete' => 'Спасибо за ваш отзыв, ваше мнение очень важно для нас',
            'author' => 'Автор: :author',
            'anonymous' => 'Аноним',
        ],
        'order' => [
    ...
    'message' => [
        'app_name' => 'SV Finance',
        'greeting' => "
👋 Добро пожаловать в SV FINANCE!
Мы здесь, чтобы помочь вам с организацией финансовых вопросов:
- с обменом наличных и криптовалют
- с денежными переводами по всему миру
- с оплатой зарубежных инвойсов и счетов
",
        'start' => "
📌 Мы предлагаем:
💱 Обмен наличных валют: Надежные решения для обмена с минимальными рисками.
💸 Переводы средств: Быстро и безопасно переведем деньги за границу или наоборот.
🌍 Оплата инвойсов: Закрывайте зарубежные счета без лишних сложностей и оплачивайте любые покупки — от крупных до повседневных..
🚢 Решения для моряков:  Легальные и надежные переводы зарплат с международных систем (например, MarTrust, ShipMoney) с минимальными комиссиями. Получите деньги на карту российского банка или наличными в более чем 240 городах мира.
🏡 Финансовое сопровождение любых крупных покупок: Легальные переводы для приобретения недвижимости, авто, яхт.
💼 Для бизнеса: Оплата зарубежных инвойсов и поддержка международной деятельности.
💱 Криптовалюта: Покупка и продажа BTC, ETH, USDT и других активов через проверенные платформы.
🌍 Консалтинг по релокации: Помощь с переездом, оформлением ВНЖ, регистрацией компаний и банковских счетов.

💬 Как мы можем помочь вам сегодня?
1️⃣ Выберите интересующую услугу.
2️⃣ Оставьте запрос — мы свяжемся с вами в ближайшее время.
3️⃣ Задайте вопрос, и наш специалист ответит максимально оперативно.

📞 Свяжитесь с нами для консультации и начните пользоваться безопасными и профессиональными финансовыми решениями!

➡️ Выберите раздел или напишите ваш вопрос.
        ",
        ...
        'payment_invoices_file' => 'Отправьте файл или нажмите продолжить:',
        'success_file' => 'Фаил получен:',
    ],
    'button' => [
        'home' => '🏠 Главная',
        ...
        'anonymous_feedback' => '✅ Оставить анонимный отзыв',
    ...
    'errors' => [
        ...
        'feedback_str_length' => '🤷 Значение должно быть не меньше 3 символов ',
