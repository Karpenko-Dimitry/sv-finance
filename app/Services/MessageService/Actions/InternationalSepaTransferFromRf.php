...
class InternationalSepaTransferFromRf extends AbstractAction
{
    ...
    public function start(): static
    {
        ...
        $this->messageService->order->syncSteps(
            ...
            trans('telegram.international_sepa_transfer_from_rf.order.direction'),
            $this->messageService->getSelectedOptionName()
        );

        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = $text ?? trans('telegram.international_sepa_transfer_from_rf.message.recipient_country');
    ...
    public function recipient_amount(): static {
        ...
        $this->messageService->order->syncSteps(
            $this->getActionKey(__FUNCTION__),
            trans('telegram.international_sepa_transfer_from_rf.order.recipient_country'),
            $this->messageService->getSelectedOptionName()
        );
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = $text ?? trans('telegram.international_sepa_transfer_from_rf.message.recipient_amount');
        $reply_markup = new Keyboard(['inline_keyboard' => [
            [
                ['text' => trans('telegram.button.back'), 'callback_data' => $this->messageService->getBackKey($this->getActionKey(__FUNCTION__))],
            ]
    ...
    public function recipient_currency(): static
    {
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = trans('telegram.international_sepa_transfer_from_rf.message.recipient_currency');
        $this->messageService->order->syncSteps(
            $this->getActionKey(__FUNCTION__),
            trans('telegram.international_sepa_transfer_from_rf.order.recipient_amount'),
            $this->messageService->getSelectedOptionName()
        );
    ...
    public function recipient_custom_currency(): static
    {
        ...
        $this->messageService->order->syncSteps(
            $this->getActionKey(__FUNCTION__),
            trans('telegram.international_sepa_transfer_from_rf.order.recipient_currency'),
            $this->messageService->getSelectedOptionName()
        );
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = $text ?? trans('telegram.international_sepa_transfer_from_rf.message.recipient_currency');
        $reply_markup = new Keyboard(['inline_keyboard' => [
            [
                ['text' => trans('telegram.button.back'), 'callback_data' => $this->messageService->getBackKey($this->getActionKey(__FUNCTION__))],
            ]
    ...
    public function transfer_type(): static
    {
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = trans('telegram.international_sepa_transfer_from_rf.message.transfer_type');
        $this->messageService->order->syncSteps(
            $this->getActionKey(__FUNCTION__),
            trans('telegram.international_sepa_transfer_from_rf.order.recipient_currency'),
            $this->messageService->getSelectedOptionName()
        ...
        $reply_markup = new Keyboard(['inline_keyboard' => [
            [
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.cash'), 'callback_data' => $this->getActionKey('city_cash_transfer')],
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.card'), 'callback_data' => $this->getActionKey('bank_transfer')],
            ], [
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.crypto_wallet'), 'callback_data' => $this->getActionKey('cart')],
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.custom'), 'callback_data' => $this->getActionKey('custom_transfer')],
            ], [
                ['text' => trans('telegram.button.back'), 'callback_data' => $this->messageService->getBackKey($this->getActionKey(__FUNCTION__))],
            ]
        ]]);
    ...
    public function city_cash_transfer(): static
    {
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = trans('telegram.international_sepa_transfer_from_rf.message.city_cash_transfer');
        $this->messageService->order->syncSteps(
            $this->getActionKey(__FUNCTION__),
            trans('telegram.international_sepa_transfer_from_rf.order.transfer_type'),
            $this->messageService->getSelectedOptionName()
        );
    ...
    public function custom_city_cash_transfer(): static
    {
        ...
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = $text ?? trans('telegram.international_sepa_transfer_from_rf.message.city_cash_transfer');
        $reply_markup = new Keyboard(['inline_keyboard' => [
            [
                ['text' => trans('telegram.button.back'), 'callback_data' => $this->messageService->getBackKey($this->getActionKey(__FUNCTION__))],
            ]
    ...
    public function cart(): static {
        ...
        $this->messageService->order->syncSteps(
            $this->getActionKey(__FUNCTION__),
            trans('telegram.international_sepa_transfer_from_rf.order.' . $key),
    ...
    public function bank_transfer(): static
    {
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = trans('telegram.international_sepa_transfer_from_rf.message.bank_transfer');
        $this->messageService->order->syncSteps(
            $this->getActionKey(__FUNCTION__),
            trans('telegram.international_sepa_transfer_from_rf.order.transfer_type'),
            $this->messageService->getSelectedOptionName()
        ...
        $reply_markup = new Keyboard(['inline_keyboard' => [
            [
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.tbank'), 'callback_data' => $this->getActionKey('cart')],
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.sberbank'), 'callback_data' => $this->getActionKey('cart')],
            ], [
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.rnkb'), 'callback_data' => $this->getActionKey('cart')],
                ['text' => trans('telegram.international_sepa_transfer_from_rf.button.custom'), 'callback_data' => $this->getActionKey('custom_bank_transfer')],
            ], [
                ['text' => trans('telegram.button.back'), 'callback_data' => $this->messageService->getBackKey($this->getActionKey(__FUNCTION__))],
            ]
        ]]);
    ...
    public function custom_bank_transfer(): static
    {
        ...
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = $text ?? trans('telegram.international_sepa_transfer_from_rf.message.bank_transfer');
        $reply_markup = new Keyboard(['inline_keyboard' => [
            [
                ['text' => trans('telegram.button.back'), 'callback_data' => $this->messageService->getBackKey($this->getActionKey(__FUNCTION__))],
            ]
    ...
    public function custom_transfer(): static
    {
        ...
        $chat_id = $this->messageService->chatId;
        $message_id = $this->messageService->messageId;
        $text = $text ?? trans('telegram.international_sepa_transfer_from_rf.message.custom_transfer');
        $reply_markup = new Keyboard(['inline_keyboard' => [
            [
                ['text' => trans('telegram.button.back'), 'callback_data' => $this->messageService->getBackKey($this->getActionKey(__FUNCTION__))],
            ]
